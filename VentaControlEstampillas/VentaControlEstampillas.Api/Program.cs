...
app.MapGroup("/api/estampillas").MapearEstampillas().AddEndpointFilterFactory(ValidationFilter.ValidationFilterFactory);
app.MapGroup("/api/clientes").MapearClientes().AddEndpointFilterFactory(ValidationFilter.ValidationFilterFactory);
app.MapGroup("/api/ventas-estampillas").MapearVentasEstampillas().AddEndpointFilterFactory(ValidationFilter.ValidationFilterFactory);
app.Run();
